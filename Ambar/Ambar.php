...
<?php  
$Find=file_get_contents("/Users/Jonathan/Documents/435/Support/text.json");
...
$rest=$_POST["rname"];
  $data['Restaurants'][] = array($_POST["rname"]=>array("Comments"=>array(array($userName=>($_POST["interest"])))));
    ...
    if ($_POST){//always check, to avoid noticed
        file_put_contents('/Users/Jonathan/Documents/435/Support/text.json', json_encode($data,JSON_PRETTY_PRINT));
    }
